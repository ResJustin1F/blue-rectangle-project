...
# Create a new 1280 x 720 window called Color Gradient - Step 2 using the GraphWin function.
window2 = GraphWin("Color Gradient - Step 2", 1280, 720)
...
# Create a new Image object and assign it to the variable blu_img
