...
# Create a new 1280 x 720 window called Skater Heaven - Step 3 using the GraphWin function.
window3 = GraphWin("Skater Heaven - Step 3", 1280, 720)
...
# Create a new Image object and assign it to the variable background_img
...
# Create another Image object and assign it to the variable existing_img
